...
Tsifier.prototype.generateCache = function (files) {
	...
	var self = this;
	var declarationsArray = Array.isArray(self.opts.declarationFiles)? self.opts.declarationFiles : [self.opts.declarationFiles];

	declarationsArray.forEach(function(declarationFiles) {
		var dtsFiles = glob.sync(declarationFiles, {})
